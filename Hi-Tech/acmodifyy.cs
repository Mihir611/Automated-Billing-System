...
namespace Hi_Tech
{
    public partial class acmodifyy : Form
    {
        public acmodifyy()
        {
            InitializeComponent();
        ...
        private void acmodifyy_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    con.Open();
                    cmd = new SqlCommand("INSERT INTO Sup_det(Name,Address,Country,State,Email,Mobile_no,Tel_no,Contact_Per,Pin_code,Fax,Acgroup,OpBal,Bal,Station,Gstin)VALUES(@Name,@Address,@Country,@State,@Email,@Mobile_no,@Tel_no,@Contact_Per,@Pin_code,@Fax,@Acgroup,@OpBal,@Bal,@Station,@Gstin)", con);
